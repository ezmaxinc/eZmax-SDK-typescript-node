...
export class ObjectEzsignfolderApi {
     ...
     * @param pkiEzsignfolderID The unique ID of the Ezsignfolder
     */
    public async ezsignfolderGetObjectGetChildrenV1 (pkiEzsignfolderID: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
